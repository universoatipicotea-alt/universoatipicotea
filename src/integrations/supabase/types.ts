    ...
    Tables: {
      ...
      ua_forum_comments: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "ua_forum_comments_parent_comment_id_fkey"
            columns: ["parent_comment_id"]
            isOneToOne: false
            referencedRelation: "ua_forum_comments"
            referencedColumns: ["id"]
          },
          {
      ...
      ua_forum_reactions: {
        ...
        Relationships: [
          {
            foreignKeyName: "ua_forum_reactions_comment_id_fkey"
            columns: ["comment_id"]
            isOneToOne: false
            referencedRelation: "ua_forum_comments"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "ua_forum_reactions_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "ua_users"
            referencedColumns: ["id"]
      ...
      ua_forum_reports: {
        ...
        Relationships: [
          {
            foreignKeyName: "ua_forum_reports_comment_id_fkey"
            columns: ["comment_id"]
            isOneToOne: false
            referencedRelation: "ua_forum_comments"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "ua_forum_reports_reporter_id_fkey"
            columns: ["reporter_id"]
            isOneToOne: false
            referencedRelation: "ua_users"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "ua_forum_reports_reviewed_by_fkey"
            columns: ["reviewed_by"]
            isOneToOne: false
            referencedRelation: "ua_users"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "ua_forum_reports_topic_id_fkey"
            columns: ["topic_id"]
            isOneToOne: false
            referencedRelation: "ua_forum_topics"
            referencedColumns: ["id"]
