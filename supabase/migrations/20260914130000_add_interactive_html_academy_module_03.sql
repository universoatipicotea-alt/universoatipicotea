...
SET allowed_mime_types = CASE
  WHEN allowed_mime_types IS NULL THEN ARRAY['application/pdf', 'text/html']::text[]
  WHEN NOT ('text/html' = ANY(allowed_mime_types)) THEN array_append(allowed_mime_types, 'text/html')
